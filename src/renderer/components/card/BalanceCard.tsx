...
const BalanceCard = () => {
  ...
  return (
    <>
      <div className=" w-[24.4rem] h-[13.2rem] stats bg-gradient-to-r from-blue-600 to-blue-400 text-primary-content container py-2">
        <div className="">
          <div className="grow">
          ...
          <div>
            <div className="text-6xl pl-24 text-white font-bold">${currentBalance}</div>
          </div>
          <div>
