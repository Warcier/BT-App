...
function SpendingCard(props) {
  ...
  return (
    <div className="stats text-white w-[24.4rem] height-fixed transition delay-75 ease-in-out bg-blue-600 hover:bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 transform active:-translate-y-2 shadow shadow-xl hover:shadow-lg">
      <div className="stat">
